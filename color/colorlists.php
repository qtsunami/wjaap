...
die;
function language_json($url)  #获取GOOGLE返回的信息
{
if(false)
{
...
#参数1:要翻译的内容、参数2:当前语言 %7C  要翻译的语言
function tran($value,$langpair)  {
$value=urlencode($value);
//$languageurl="http://ajax.googleapis.com/ajax/services/language/translate?v=1.0&q=".$value."&langpair=".$langpair."";
//$languageurl = "https://www.googleapis.com/language/translate/v2?key=YOUR-API-KEY&source=en&target=de&callback=translateText&q=' + sourceText";
$languageurl = 'https://translate.google.com.hk/translate_a/t?client=t&sl=zh-CN&tl=en&hl=zh-CN&sc=2&ie=UTF-8&oe=UTF-8&oc=2&prev=conf&psl=zh-CN&ptl=zh-CN&otf=1&it=sel.2161&ssel=0&tsel=0&q=英雄';
$text=language_json($languageurl);

var_dump($text);die;
return $text->responseData->translatedText;
}
echo tran('中国','zh%7Cen');
